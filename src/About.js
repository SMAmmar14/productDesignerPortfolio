...
<Jumbotron className = "headerJumbotron">
        <div className="intro py-5">
          <Container>
            <div className="row d-flex align-items-center">
              ...
              <h1 className = "headerStyle"> Hi, I'm Ammar <span aria-label="waving hand" role="img">👋</span></h1>
                <p className="subHeaderText"> I'm a product designer at CAKE working on the iOS mobile and web application.
                </p><div className="row">
                ...
                <p>Because I've done my major in computer science and working as a designer, I know some of the critical tech words that are critical.</p>
                <p>Currently, I'm a product designer at CAKE based in California, working on iOS mobile and web application previously i was at a startup called PeerDrop</p>
                <p>Apart from work, you'll find me running in my society. Going for cycling on weekends. If you are down for some Dota2 or Valorant hit me up.</p>
               </div>
              </div>
      ...
      <div className="container mt-5">
        ...
        <div className="row">
            ...
            <p>I've been solving problems for humans professionally  since 2020. </p>
            <p>It started in April 2019 when I won first ever season of Ideacon at my university and then graduated with a degree following year.
                After that my romance with problem solving introduced me to problem solving and after that it was no looking back. </p>
            </div>
            </div>
            <div className="col-md-4 col-lg-4">
            ...
            <p>I grew up on the streets of Karachi playing cricket and football.</p>
            </div>
            </div>
            <div className="col-md-4 col-lg-4">
