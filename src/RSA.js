        ...
        <Row>
          <div className="col-md-5">
            ...
            <div className="myRoleBodyCopy">
              <p>
                I led the product design process for Cake Affiliate on iOS.
              </p>
              <p> I was responsible for creating the entire end to end UX flow of the Digital Affiliate experience for the app.</p>
              <p> I was tasked with working in collaboration with project manager, engineer and businesses to design the end to end digital affiliates experience.
              </p>
            </div>
          </div>
          <div className="offset-md-2 col-md-5">
            ...
            <ul className="whatIDidCopy">
              ...
              <li>Created the visual language of the app</li>
              <li>Executive presentations</li>
              <li>Fostering relationships and understanding requirements with businesses via usability testing and user interviews</li>
              <li>Facilitated product design workshops withs stakeholders</li>
