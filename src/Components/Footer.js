                ...
                <div className="row footerPadding">
                    ...
                    <div className="offset-md-1 col-xs-6 col-md-2">
                        ...
                        <ul className="footerList">
                            ...
                            <li className="mb-1"><a rel="noopener noreferrer" target="_blank" href="https://drive.google.com/file/d/1aHWUim-XtevDZqe9y1h0HDfVgltD0U2Y/view?usp=sharing">Resume</a></li>
